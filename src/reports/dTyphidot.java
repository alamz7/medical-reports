...
public class dTyphidot extends JDialog {
	...
	void SetPanels(){
		...
		JLabel CBC = new JLabel("Typhidot IGM");
		CBC.setFont(new Font("Calibri Light", Font.PLAIN, 11));
		CBC.setBounds(10, 65, 70, 14);
		pnlCBC.add(CBC);			
		...
		JLabel lblNewLabel = new JLabel("Non Reactive");
		...
		JLabel lblNewLabel_4 = new JLabel("Typhidot IGG");
		lblNewLabel_4.setFont(new Font("Calibri Light", Font.PLAIN, 11));
		lblNewLabel_4.setBounds(10, 102, 70, 14);
		pnlCBC.add(lblNewLabel_4);
		
		txt2 = new JTextField();
		txt2.setFont(new Font("Calibri", Font.PLAIN, 11));
		txt2.setBounds(90, 99, 86, 20);
		pnlCBC.add(txt2);
		txt2.setColumns(10);
		
		JLabel lblNewLabel_5 = new JLabel("Non Reactive");
		lblNewLabel_5.setFont(new Font("Calibri Light", Font.PLAIN, 11));
		lblNewLabel_5.setBounds(253, 105, 89, 14);
